...
module.exports = function (CONFIG, client, msg, wsapi, sendToChannel, sendEmbedToChannel, preferences, ACCESS_LEVEL, server_RL, user_RL) {
    ...
    /** @command migratelinks
     *  @protected
     *  @description Migrates tracking settings from v1 to v2 database. Will overwrite.
     *  @permissionlevel 5
     * **/
     ...
     *  @permissionlevel 0
     * **/
    command(usePrefix(["help", "docs", "documentation", "commands"]), false, cPL("general"), (original, index) => {
